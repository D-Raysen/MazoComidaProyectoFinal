...
import static com.danieleloy.mazocomida.clases.ImagenesBlobBitmap.bytes_to_bitmap;
...
public class ImagenesFirebase {
    ...
    public static void subirFoto( String nombre_carpeta, String nombre, ImageView img_add_foto) {
        ...
        StorageReference foto2Ref = storageRef.child(nombre_carpeta+"/Comida"+String.valueOf(nombre)+".png");
    ...
    public static void descargarFoto(String nombre_carpeta, String nombre, ImageView imagendescargada) {
        FirebaseStorage storage = FirebaseStorage.getInstance();
        StorageReference storageRef = storage.getReference();
        StorageReference islandRef = storageRef.child(nombre_carpeta+"/Comida"+nombre+".png");
        ...
        islandRef.getBytes(tam_foto).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                imagendescargada.setImageResource(R.drawable.hamburguesacheddar);
            }
        });
    }
